...
const Dashboard = () => {
  ...
  const loadHistory = async () => {
    const result = await axios.get(`https://gift-of-the-gab.herokuapp.com/api/history/${id}/`);
    history = result.data;
    var i = 0;
    console.log('blah')
    console.log(history)
  ...
  const loadWeekstreak = async () => {
    const result = await axios.get(`https://gift-of-the-gab.herokuapp.com/api/weekstreak/${id}/`);
    streak = result.data;
    console.log(streak)
